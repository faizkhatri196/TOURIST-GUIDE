...
import { Shield, Mail, Lock, User, Sparkles, AlertCircle } from 'lucide-react';
...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen bg-black pt-24 pb-16 px-6 font-sans text-zinc-100 flex items-center justify-center">
      ...
      >
        <div>
          ...
          <h2 className="text-center text-lg font-bold text-white uppercase tracking-wider mb-2">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 bg-gradient-to-r from-royal-blue to-emerald-green text-black font-semibold text-xs uppercase tracking-wider rounded-xl hover:opacity-90 transition-all flex items-center justify-center gap-2"
            >
              {loading ? (
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-2 border border-white/10 rounded-xl bg-white/5 hover:bg-white/10 text-xs font-semibold text-zinc-200 transition-all"
            >
              Google
            </button>
            <button
